  ...
  return (
    <div className='hero-bg py-10 border-b border-neutral-200'>
      <div className='max-w-7xl mx-auto px-2 lg:px-0'>
        <div className='flex flex-col gap-y-4 lg:gap-y-0 lg:flex-row items-center justify-between'>
          <div>
            <h1 className='text-2xl font-semibold text-gray-900 mb-1'>Welcome, {user?.firstName}!</h1>
