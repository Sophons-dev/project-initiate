...
export function UserTypeStep() {
  ...
  const [selectedUserType, setSelectedUserType] = useState<'student' | 'professional' | null>(data.userType);
      ...
      <div className='space-y-2 mb-8 bg-neutral-100 p-3 rounded-xl'>
          ...
          <div className='flex items-center space-x-3'>
            <div
              className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                selectedUserType === 'student' ? 'border-cyan-500 bg-cyan-500' : 'border-gray-300'
              }`}
            >
              {selectedUserType === 'student' && <div className='w-2 h-2 bg-white rounded-full' />}
            </div>
        ...
        >
          <div className='flex items-center space-x-3'>
            ...
            >
              {selectedUserType === 'professional' && <div className='w-2 h-2 bg-white rounded-full' />}
            </div>
