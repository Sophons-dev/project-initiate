      ...
      <div className='container max-w-7xl mx-auto'>
        <div className='flex flex-col-reverse md:flex-row gap-6 lg:gap-12 items-center'>
          ...
          <div className='md:w-1/2'>
            <TextPill
              className='mx-0 mb-8 mt-0 !text-xs text-orange-500 bg-orange-50'
              icon={<GraduationCap className='w-4 h-4' />}
              text='For Professionals'
            />

            <h2 className='text-3xl lg:text-4xl md:max-w-md text-black mb-6'>
              Accelerate your <span className='text-orange-500'>Career Growth</span> with AI
            </h2>
            ...
            {/* <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button asChild className='bg-orange-600 hover:bg-orange-600'>
                <Link href='/sign-in'>Explore Professional Opportunities</Link>
              </Button>
            </motion.div> */}
          </div>
        </div>
