    ...
    return (
        <motion.div
            ...
            <div className='text-center mb-8'>
                <h1 className='text-2xl font-semibold text-gray-900 mb-2'>Welcome to Initiate</h1>
                <p className='text-gray-600 text-sm'>Your journey to the perfect career starts here</p>
            </div>
