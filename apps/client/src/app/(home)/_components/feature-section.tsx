            ...
            <motion.div style={{ y: yFeatures }} className="container max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto">
                        Discover how our platform uses cutting-edge technology to connect you with the right opportunities at the right time.
                    </p>
                </motion.div>
                            ...
                            <Card className="p-6 h-full hover:shadow-xl transition-all border duration-300 group cursor-pointer bg-[#F9F8FC]">
                                <CardContent className="p-0 flex flex-col gap-y-6">
                                    ...
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                    >
                                        <motion.h3 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="mb-2">{feature.title}</motion.h3>
                                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }} viewport={{ once: true }} className="text-gray-600 text-sm">
                                            {feature.description}
                                        </motion.p>
                                    </motion.div>
                                </CardContent>
...
const features = [
    {
        ...
        description: "Our advanced AI analyzes your profile, skills, and preferences to find the most relevant opportunities that are aligned with your interests.",
        content: (
            <div className="w-full h-[280px] flex flex-col gap-y-10 items-center justify-center  relative">
                ...
                <div className="h-fit shadow-sm z-20 bg-neutral-200/50 p-3 border border-white rounded-2xl">
                    <div className="bg-white flex flex-col gap-y-2 p-3 rounded-xl">
                        <p className="text-xs flex items-center gap-2 text-cyan-500"><Sparkles className="w-4 h-4" />Why this matches you:</p>
                        <p className="text-xs text-gray-600 line-clamp-3 xl:line-clamp-5">Based on your design portfolio, this workshop will enhance your UX research skills and expand your design thinking methodology.</p>
                    </div>
                </div>
    ...
    },
    {
        ...
        description: "We provide tailored suggestions based on your career goals, interests, and current skill level ensuring that they matches you.",
        content: (
                ...
                <div className="h-fit w-[90%] shadow-sm z-20 bg-neutral-200/50 p-3 border border-white rounded-2xl">
                    <div className="bg-white relative p-3 rounded-xl flex flex-col gap-y-3">
                        ...
                        <div className="flex flex-col mt-8 items-start gap-y-0.5">
                            ...
                            <p className="text-xs text-gray-600 flex items-center gap-1"><Building className="w-4 h-4" />Design Academy</p>
                            <p className="text-xs text-gray-600 flex items-center gap-1"><MapPin className="w-4 h-4" />New York, NY</p>
                        </div>

                        <p className="text-xs text-gray-600 line-clamp-3 xl:line-clamp-3">A comprehensive 3-day workshop covering user research, wireframing, prototyping, and usability testing. Perfect for designers looking to enhance their design skills.</p>

                        <div className="p-2 bg-[#F8F9FA] rounded-xl">
                            <p className="text-xs flex items-center gap-2 text-cyan-500"><Sparkles className="w-3 h-3" />Why this matches you:</p>
                            <p className="text-xs text-gray-600 line-clamp-3 xl:line-clamp-2">Based on your design portfolio, this workshop will enhance your UX research skills and expand your design thinking methodology.</p>
                        </div>
                    </div>
                </div>
    ...
    },
    {
        ...
        description: "Most of the opportunities come from partnered and verified, reputable organizations and institutions.",
        content: (
            <div className="w-full h-[280px] flex flex-col gap-y-10 items-center justify-end relative">
                {/* Top */}
                ...
                <div className="absolute -bottom-25 right-0 h-fit w-[80%] shadow-sm z-20 bg-neutral-200/50 p-3 border border-white rounded-2xl">
                    <div className="bg-white relative p-3 rounded-xl flex flex-col gap-y-3">
                        ...
                        <div className="flex flex-col mt-8 items-start gap-y-0.5">
                            ...
                            <p className="text-xs text-gray-600 flex items-center gap-1"><MapPin className="w-4 h-4" />Manila, Philippines</p>
                        </div>
