...
export const HeroSection = () => {
    ...
    return (
        <section
            ref={heroRef}
            className='py-10 md:py-16 relative md:mt-15 px-4 md:px-0 overflow-x-hidden'>
            <motion.div
                style={{ y: yHero }}
                ...
                <motion.div
                    ...
                    <Button
                        size={'lg'}
                        className='rounded-full bg-gradient-to-b from-cyan-400 to-cyan-600 border-4 py-5 border-neutral-100 hover:bg-cyan-600 mb-12 relative overflow-hidden group'>
                ...
                <div className='relative border-t border-t-neutral-100 rounded-t-2xl mx-auto md:p-15 pb-0'>
                    <motion.div
                        className='container max-w-7xl border-10 border-b-0 rounded-bl-none rounded-br-none border-neutral-100 bg-[#E9E9E9]/20 md:p-10 p-2 rounded-2xl mx-auto'
                        ...
                        <motion.div
                            ...
                            <div className='p-4 bg-white'>
                                <div className='flex items-start space-x-2 mb-2 md:mb-4'>
                                    <Sparkles className='w-4 md:w-5 h-4 md:h-5 text-black' />
                                    <span className='text-sm md:text-normal font-medium text-black'>AI Career Insights</span>
                                </div>
                                <motion.p
                    ...
                    <div className='absolute h-45 bottom-0 left-0 right-0 bg-gradient-to-b from-white/0 via-white/70 to-white' />
                </div>
            </motion.div>
