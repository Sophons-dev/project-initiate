        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div className="space-y-2 mb-8 bg-neutral-100 p-3 rounded-xl">
                <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`p-4 border rounded-lg cursor-pointer transition-all ${selectedType === "student" ? "border-cyan-500 bg-cyan-50" : "border-gray-200 hover:border-gray-300 bg-white"
                        }`}
                    onClick={() => setSelectedType("student")}
                >
                    <div className="flex items-center space-x-3">
                        <div
                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedType === "student" ? "border-cyan-500 bg-cyan-500" : "border-gray-300"
                                }`}
                        >
                ...
                <motion.div
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${selectedType === "professional"
                ...
                >
                    <div className="flex items-center space-x-3">
                        <div
                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedType === "professional" ? "border-cyan-500 bg-cyan-500" : "border-gray-300"
                                }`}
                        >
