        ...
        <motion.header
            ...
            <div className='relative container mx-auto flex items-center justify-between'>
                ...
                <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}>
                    <Link href='/'>
                        <Image src='/project-initiate-logo.png' alt='Logo' width={80} height={80} />
                    </Link>
                </motion.div>
                ...
                <nav className='absolute left-1/2 transform -translate-x-1/2 md:flex items-center space-x-1'>
                    {navLinks.map((item, index) => (
                        <motion.div
                            ...
                            <Link
                                href={item.href}
                                className={`relative group text-sm px-4 py-1.5 rounded-full font-medium transition-colors duration-200 ${activeSection === item.href.replace('#', '')
