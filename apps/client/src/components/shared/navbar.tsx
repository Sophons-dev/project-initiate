...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='relative container mx-auto flex items-center justify-between px-4 h-full'>
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button variant='ghost' className='hidden md:inline-flex hover:bg-transparent'>
              Sign In
            </Button>
          </motion.div>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
