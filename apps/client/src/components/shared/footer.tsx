        ...
        <footer className="border-t bg-[#1C1C1C] mt-10 px-4 lg:px-0">
            <div className="container max-w-7xl mx-auto py-10 text-white">
                ...
                >
                    ...
                    <div className="text-sm text-muted-foreground my-3">Get notified about the latest courses, jobs, and events that match your profile</div>
                ...
                <div className="grid gap-8 text-sm md:grid-cols-6 border-t border-b border-neutral-600 py-10">
                    ...
                    {footerSections.map((section) => (
                        <motion.div key={section.title} variants={fadeInUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
