...
import { Bookmark, Building2, Calendar, MapPin, Share2, Sparkles } from 'lucide-react';
          ...
          <Card className='h-full rounded border hover:shadow transition-all duration-300'>
            <CardContent className=''>
              ...
              <div className='flex items-center justify-between mb-4'>
                <span className={`px-3 py-1 rounded text-xs font-medium ${opportunity.typeColor}`}>
                  {opportunity.type}
                </span>
              ...
              <div className='bg-yellow-50 border-l-3 rounded-l-none border-l-yellow-500 rounded-lg p-3 mb-4'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-yellow-700 leading-relaxed'>{opportunity.matchReason}</p>
                  </div>
                </div>
              </div>
...
const opportunityData = [
  {
    ...
    matchReason:
      'Based on your design portfolio, this workshop will enhance your UX research skills and expand your design thinking methodology.',
